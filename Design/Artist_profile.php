...
function DeletePosts(post_id) {
  window.location.href = 'DeleteBlog.php?post_id=' + post_id;
}
</script>
      </head>
      <body>
    ...
    <!-- Top navbar -->
        ...
        <li class="current"><a href="Artist_profile.php">My Profile</a></li>
              </ul>
          ...
          <div class="card-profile shadow">
            ...
            <div class="card-header text-center border-0 pt-8 pt-md-4 pb-0 pb-md-4">
              <div class="d-flex justify-content-between">
                <!-- <a href="NewBooking.php" class="btn btn-sm btn-info mr-4">Connect</a> -->
    ...
    <?php
     ...
     include('Connect.php');
     $user = $_SESSION['Username'];
     $sql = "SELECT * FROM {$_SESSION['table_name']} JOIN Blogs WHERE Blogs.username = '{$user}' AND {$_SESSION['table_name']}.username = Blogs.username";
   ...
   { ?>
    ...
    <div class="projcard projcard-blue">
      ...
      <img class="projcard-img" src="<?php echo  $rows["thumbnail_url"] ?>" />
        ...
        <button onclick="showMorePosts(<?php echo $rows['Blog_ID'] ?> )" class="custom-btn btn-3" >View</button>
        <button style="margin-top: 10px;" onclick="DeletePosts(<?php echo $rows['Blog_ID'] ?> )" class="custom-btn btn-3" >Delete</button>
        </div>
      </div>
    </div>
</div>
