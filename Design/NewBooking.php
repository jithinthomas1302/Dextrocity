...
if (isset($_SESSION['Name']) && isset($_SESSION['Username']) && isset($_GET['Artistusername'])) 
{
  include('Connect.php');
  $artist = $_GET['Artistusername'];
...
function BookArtist(username) {
  window.location.href = 'BookingPost.php?Artist=' + username;
}
</script>
      ...
      <div class="container-fluid d-flex align-items-center">
        <div class="row">
          <div class="col-lg-7 col-md-10">
            <h1 class="display-2 text-white">New Booking</h1>
            <p>Please fill in the details regarding the event you wish to book the artist for.</p>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-xl-8 order-xl-1">
          <div class="card bg-secondary shadow">
            ...
            <div class="card-body">
              <form action="BookingPost.php" method="POST" enctype="multipart/form-data" >
                <div class="pl-lg-4">
                        <input type="text" name="Artist" id="Artist" style="visibility: hidden;"value="<?php echo $_GET['Artistusername'] ?>" >
                  <div class="row">
                    <div class="col-lg-6">
                      <div class="form-group focused">
                        <label class="form-control-label" for="input-username">Event Name</label>
                        <input type="text" name="EventName" id="input-username" class="form-control form-control-alternative" placeholder="">
                      </div>
                    </div>
                ...
                <button class="btn btn-info" style=" margin-left: 20px;">Send Request</button>
              </form>
            </div>
          </div>
        </div>
