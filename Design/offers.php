...
function showMorePosts(post_id) {
  ...
  <div class = "vignette">
    ...
    <li  onclick=""><a href="blogfeed.php">Blogs</a></li>
        ...
        <li class="current"><a href="offers.php">My Bookings</a></li>
...
include('Connect.php');
$user = $_SESSION['Username'];
$sql3 = "SELECT * FROM Bookings where Customer='$user' AND Status != 'Rejected'";
$res = $con->query($sql3);
    ...
    <div class="projcard projcard-blue">
      <div class="projcard-innerbox">
			<div class="projcard-textbox">
				<div class="projcard-title"><?php echo  $row["EventName"] ?></div>
				<div class="projcard-subtitle">Requested Artist: <?php echo  $row["Artist"] ?></div>
				<div class="projcard-bar"></div>
				<div class="projcard-description">Offered Amount: <?php echo  $row["Amount"]?> <br> Artist Approval: <?php echo  $row["Status"]?></div>
